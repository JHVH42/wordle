...
def delete_letter(): # Adding handling for the "Backspace" key
    global letter_count, guess, winner #variaveis globais
    if not winner and letter_count > 0 and letter_count % 5 != 0: #se o jogo não estiver ganho e o contador de letras for maior que 0 e o contador de letras não for divisivel por 5
